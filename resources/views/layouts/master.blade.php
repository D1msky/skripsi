...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="text-left">
        ...
        <div class="app-admin-wrap layout-sidebar-vertical sidebar-full">
            ...
            <div class="main-content-wrap  mobile-menu-content bg-off-white m-0">
                ...
                <div class="main-content pt-4">
                    <div id="dvSukses" class="alert alert-card alert-success" role="alert" style="display: none">
                        <strong id="notifSukses" class="text-capitalize"></strong>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    
                    <div id="dvGagal" class="alert alert-card alert-danger" role="alert" style="display: none">
                        <strong id="notifGagal" class="text-capitalize">Danger!</strong> 
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <script type="text/javascript">
            ...
            function ShowNotification(not,cek){
                
                if(cek){
                    $("#notifSukses").html(not);
                    $("#dvSukses").show();
                    $("#dvGagal").hide();
                }else{
                    $("#notifGagal").html(not);
