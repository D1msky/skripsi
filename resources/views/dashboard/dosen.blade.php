        ...
        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
            <div class="card-body text-center">
                ...
                <div class="content">
                    ...
                    <p class="text-primary text-24 line-height-1 mb-2">{{$data['tgsaktif']}}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
            <div class="card-body text-center">
                ...
                <div class="content">
                    <p class="text-muted mt-2 mb-0">Total Mahasiswa</p>
                    <p class="text-primary text-24 line-height-1 mb-2">{{$data['jmlhmhs']}}</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-9 col-md-12">
        <div class="card mb-4">
            <div class="card-body">
                <div class="card-title">Rata-Rata Beban Tugas Mahasiswa Setiap Kelas</div>
                <div class="row">
                    <div class="col-md-3">
                        <select id="sFilterKelas" class="form-control" onchange="filterKelas(this.value)" required>
            ...
            <div class="">
                <div class="table-responsive">
                    <table id="user_table" class="table text-center">
                        ...
                        <tbody>
                            @foreach(json_decode($sortTop) as $tp)
                            <tr>
...
<div class="row">
    <div class="col-lg-9 col-md-12">
        <div class="card mb-4">
            <div class="card-body">
                <div class="card-title">Rata-Rata Nilai CPL Setiap Matakuliah</div>
                <div class="row">
                    <div class="col-md-3">
                        <select id="sFilterCpl" class="form-control" onchange="filterCpl(this.value)" required>
                            <option value="">- Filter Matakuliah -</option>
                        </select>
                    </div>
                    <div class="col-md-3">
